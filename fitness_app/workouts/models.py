...
class CategoryType(str, ChoicesStringsMixin, Enum):
    ...
    Функционална = "Функционална тренировка"
    Кардио = "Кардио тренировка"
    Аеробна = "Аеробна тренировка"
    Интензивна = "HIIT (високоинтензивна интервална)"
    Йога = "Йога"
    Пилатес = "Пилатес"
    Комбинирана = "Цяло тяло"
