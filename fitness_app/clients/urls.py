...
urlpatterns = [
    ...
    path('<int:client_id>/<str:username>/', client_details, name='client details'),
    ...
    path('trainer/<int:trainer_id>/review/', submit_trainer_review, name='submit trainer review'),
    path('submit-app-review/', submit_app_review, name='submit app review'),
